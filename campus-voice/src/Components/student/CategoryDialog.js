            ...
            </div>
            {
                ...
                !domains.departmentDomain && (
                    <div className='w-full m-auto flex justify-center h-[350px] items-center'>
                        <div role="status">
                            <svg aria-hidden="true" className="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-campus-green" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
